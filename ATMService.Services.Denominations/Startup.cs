...
namespace ATMService.Services.Denominations
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IJSonDao<DenominationModel>, JSonDao<DenominationModel>>();
            services.AddTransient<IDenominationService, DenominationService>();
            services.AddTransient<IGatewayServiceClient, GatewayServiceClient>();
